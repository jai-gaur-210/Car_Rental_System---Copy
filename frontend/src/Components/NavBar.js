          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo01" style={{padding:'10px'}}>
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              <li className="nav-item" >
                <NavLink to="/rentCar" className="nav-link" aria-current="page" style={{color: "#0a5c5f",fontSize:'20px',fontWeight:'unset'}}>Rent Car</NavLink>
              </li>
              <li className="nav-item" >
                <NavLink to="/booked" className="nav-link" aria-current="page" style={{color: "#0a5c5f",fontSize:'20px',fontWeight:'unset'}}>Booked Cars</NavLink>
              </li>

              {Object.keys(user).length==0 && <li className="nav-item">
                <NavLink to="/register" className="nav-link" style={{color: "#0a5c5f",fontSize:'20px',fontWeight:'unset'}}>SignUp</NavLink>
              </li>}
              {Object.keys(user).length==0 && <li className="nav-item">
